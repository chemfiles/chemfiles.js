...
import {autogrowStrBuffer, numberToInt64, isUnsignedInteger, check} from './utils';
...
export class Residue extends Pointer<CHFL_RESIDUE, ResidueExtra> {
     ...
     */
    static clone(residue: Residue): Residue {
